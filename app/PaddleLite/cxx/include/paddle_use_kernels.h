...
USE_LITE_KERNEL(crop_tensor, kHost, kInt32, kAny, def);
...
USE_LITE_KERNEL(expand, kHost, kFloat, kAny, float32);
USE_LITE_KERNEL(expand, kHost, kFloat, kAny, int32);
...
USE_LITE_KERNEL(gather, kARM, kFloat, kNCHW, int32);
USE_LITE_KERNEL(gather, kARM, kFloat, kNCHW, int64);
...
USE_LITE_KERNEL(slice, kARM, kInt64, kNCHW, def);
